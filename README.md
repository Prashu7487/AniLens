...
<img src="/demo/similar_anime.gif" alt="Demo" style="display:inline-block; width: 50%; margin-right: 20px;">
<img src="/demo/world_map.gif" alt="Demo" style="display:inline-block; width: 50%;">
